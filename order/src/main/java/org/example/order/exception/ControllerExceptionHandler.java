...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCreateOrderException(final InsufficientInventoryException exception,
                                                                       final WebRequest request) {
        final String message = exception.getMessage();
    ...
    private ErrorResponse createErrorResponse(final HttpStatus status, final String message, final String path) {
